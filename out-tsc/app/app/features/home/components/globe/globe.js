...
export class Globe {
    ...
    initGlobe() {
        const canvas = this.el.nativeElement.querySelector('#globe-canvas');
        if (!canvas)
            return;
        ...
        const animate = () => {
            ...
            for (let i = 0; i < 12; i++) {
                ...
                ctx.beginPath();
                ctx.ellipse(cx, cy, radius, radius * 0.3, angle, 0, Math.PI * 2);
                ctx.stroke();
            }
            // Rotate points
            ...
            for (let i = 0; i < projected.length; i++) {
                if (projected[i].depth < -radius * 0.3)
                    continue; // back face culling
                for (let j = i + 1; j < projected.length; j++) {
                    if (projected[j].depth < -radius * 0.3)
                        continue;
    ...
    static ɵfac = function Globe_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || Globe)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: Globe, selectors: [["app-globe"]], decls: 1, vars: 0, consts: [["id", "globe-canvas", "width", "320", "height", "320", "aria-hidden", "true"]], template: function Globe_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵdomElement(0, "canvas", 0);
        } }, styles: ["[_nghost-%COMP%] {\r\n  position: absolute;\r\n  inset: 0;\r\n  width: 100%;\r\n  height: 100%;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n  pointer-events: none;\r\n  z-index: 0;\r\n  overflow: hidden;\r\n}\r\n\r\n#globe-canvas[_ngcontent-%COMP%] {\r\n  width: 100%;\r\n  height: 100%;\r\n  filter: blur(0.5px);\r\n}"] });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(Globe, [{
        type: Component,
        args: [{ selector: 'app-globe', standalone: true, template: "<canvas id=\"globe-canvas\" width=\"320\" height=\"320\" aria-hidden=\"true\"></canvas>\r\n", styles: [":host {\r\n  position: absolute;\r\n  inset: 0;\r\n  width: 100%;\r\n  height: 100%;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n  pointer-events: none;\r\n  z-index: 0;\r\n  overflow: hidden;\r\n}\r\n\r\n#globe-canvas {\r\n  width: 100%;\r\n  height: 100%;\r\n  filter: blur(0.5px);\r\n}"] }]
    }], () => [], null); })();
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(Globe, { className: "Globe", filePath: "app/features/home/components/globe/globe.ts", lineNumber: 9 }); })();
